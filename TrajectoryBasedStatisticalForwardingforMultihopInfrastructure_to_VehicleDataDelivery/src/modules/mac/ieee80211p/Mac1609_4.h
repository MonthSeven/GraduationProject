...
std::map<std::string, std::vector<std::string>> EdgeJunctMapGlob;//To hold the Copy of the Junctions of each edge
std::vector<adjacentnodes> adjStructGlob;//To save the copy of the Graph data structure
class Mac1609_4 : public BaseMacLayer,
	public WaveAppToMac1609_4Interface/*, public GaussianElimination*/{
...
//						std::queue<WaveShortMessage*> queue;
				        std::queue<multipleRSUsRTpkt*> queue;
                ...
                int queuePacket(t_access_category AC,multipleRSUsRTpkt* cmsg);
				...
				multipleRSUsRTpkt* initiateTransmit(simtime_t idleSince);
...
//                Retransmission purpose
                ...
                LinkState Lstate;
                simtime_t LastSentTime;
                simtime_t retransmissionTime;
                int retransmissionnumbers = 0;
                simtime_t AckSendingDuration;
                simtime_t RetransTimer;
                simtime_t SendingDuration;
                void WriteEDCAQueueContents(multipleRSUsRTpkt* pkt);
//                end Retransmission states
	...
	public:
        ...
        void RSUsCoordinatesFile();

        void macPktTracing (std::string where_are_we, multipleRSUsRTpkt* pkt);
	...
	protected:
        ...
        cMessage* ackEvent;
//        cMessage* displaySpeed;
        bool CheckChannelIdleBeforeSending(cMessage* msg);

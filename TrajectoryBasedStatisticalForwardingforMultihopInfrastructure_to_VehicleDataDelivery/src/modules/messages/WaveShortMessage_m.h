...
/**
 * Class generated from <tt>src/modules/messages/WaveShortMessage.msg:27</tt> by nedtool.
 * <pre>
 ...
 *     int securityType = 0;
 *     //Channel Number on which this packet was sent (Used in mac handle upperMessage)
 *     int channelNumber;
 *     //Data rate with which this packet was sent
 *     int dataRate = 1;
 *     //Power Level with which this packet was sent (Used as access Category in mac)
 *     int priority = 3;

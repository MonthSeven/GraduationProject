...
//Modifications
std::list<std::string> TraCICommandInterface::getDetectorsList(){
   return genericGetStringList(CMD_GET_MULTI_ENTRY_EXIT_DETECTOR_VARIABLE, "",ID_LIST,RESPONSE_GET_MULTI_ENTRY_EXIT_DETECTOR_VARIABLE);
}
int TraCICommandInterface::getLastStepVehicleNumber(std::string detectorId){
 return genericGetInt(CMD_GET_MULTI_ENTRY_EXIT_DETECTOR_VARIABLE, detectorId, LAST_STEP_VEHICLE_NUMBER, RESPONSE_GET_MULTI_ENTRY_EXIT_DETECTOR_VARIABLE);
}
int TraCICommandInterface::getLastStephaltingVehiclesNumber(std::string detectorId){
    return genericGetInt(CMD_GET_MULTI_ENTRY_EXIT_DETECTOR_VARIABLE, detectorId, LAST_STEP_VEHICLE_HALTING_NUMBER,RESPONSE_GET_MULTI_ENTRY_EXIT_DETECTOR_VARIABLE);
}
int TraCICommandInterface::getInductionLoopCount(){
    return genericGetInt(CMD_GET_INDUCTIONLOOP_VARIABLE, "", ID_COUNT, RESPONSE_GET_INDUCTIONLOOP_VARIABLE);
}
std::list <std::string>  TraCICommandInterface::getInductionLoopIds(){
    return genericGetStringList(CMD_GET_INDUCTIONLOOP_VARIABLE, "",ID_LIST, RESPONSE_GET_INDUCTIONLOOP_VARIABLE);
}
std::string TraCICommandInterface::getInductionLoopLaneIdE1(std::string InductionLoopId){
    return genericGetString(CMD_GET_INDUCTIONLOOP_VARIABLE, InductionLoopId, VAR_LANE_ID, RESPONSE_GET_INDUCTIONLOOP_VARIABLE);
}
int TraCICommandInterface::getLastStepVehicleNumberE1(std::string InductionLoopId){
    return genericGetInt(CMD_GET_INDUCTIONLOOP_VARIABLE, InductionLoopId, LAST_STEP_VEHICLE_NUMBER, RESPONSE_GET_INDUCTIONLOOP_VARIABLE);
}
double TraCICommandInterface::getLastStepMeanSpeed(std::string InductionLoopId){
    return genericGetDouble(CMD_GET_INDUCTIONLOOP_VARIABLE, InductionLoopId, LAST_STEP_MEAN_SPEED, RESPONSE_GET_INDUCTIONLOOP_VARIABLE);
}
/*std::list<std::string> TraCICommandInterface::getEdgesList(){

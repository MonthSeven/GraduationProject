...
//
//    //To insert the array for selection the random edge by sejun 2015-05-06
//    std::string in_edge;
...
//    return TraCICoord(coord.x,coord.y);
...
//    if (numRead != 5) return;
////    std::cout << "\\\  TraCI Coordinates : "<<" X = "<<px << " Y = "<< py <<endl; //Added in debug

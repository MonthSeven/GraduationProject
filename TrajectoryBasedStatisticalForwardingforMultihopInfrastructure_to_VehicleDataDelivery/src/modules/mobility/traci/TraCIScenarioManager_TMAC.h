...
////
//
//#ifndef VEINS_WORLD_TMAC_TRACISCENARIOMANAGER_H
//#define VEINS_WORLD_TMAC_TRACISCENARIOMANAGER_H
//
//#include <map>
//#include <list>
//#include <queue>
...
//        //by sejun, 2015-05-06
//
//        vector <std::string> arr_edge;
//        map <string , string> arr_vehicle;
//        map <string ,  int> arr_flag_vehicle;
//        map <string , string>::iterator FindIter1;
//        map <string , int>::iterator FindIter2;
//

	...
	public WaveAppToMac1609_4Interface
{
	public:
		...
		class EDCA // nested class in Mac1609_4 EDCA(Enhanced Distributed Channel Access)
		{
			public:
				class EDCAQueue //  nested class in Mac1609_4::EDCA
				{
					public:
						//std::queue<WaveShortMessage*> queue; // WaveShortMessage형 큐.
				        std::queue<kwon*> queue;
						int aifsn; //number of aifs slots for this queue // Arbitration Interframe Space (AIFS)
				...
				int queuePacket(t_access_category AC, kwon* cmsg);
				...
				kwon* initiateTransmit(simtime_t idelSince);
			public:
